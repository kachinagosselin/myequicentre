class Horse < ActiveRecord::Base
    ...
    has_attached_file :avatar, :styles => { :large => "900x600#", :medium => "275x245#", :thumb => "100x100#" }, :url => "/:attachment/:id/:style/:basename.:extension", :path => ":rails_root/public/:attachment/:id/:style/:basename.:extension", :default_url => "/images/default/:style/default_horse.jpg"
