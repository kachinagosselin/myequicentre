class Horse < ActiveRecord::Base
    ...
    has_attached_file :avatar, :styles => { :large => "900x600#", :medium => "452x368#", :thumb => "100x100#" }, :default_url => "/images/default/:style/default_horse.jpg" #, :url => "/:attachment/:id/:style/:avatar_file_name.:extension", :path => ":rails_root/public/:attachment/:id/:style/:avatar_file_name"
